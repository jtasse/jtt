...
export function createPyramid() {
	...
	// Build pyramid from individual faces (matches working version)
	const size = 3.375
	const height = 3.025
	...
	faces.forEach((f) => {
		...
		mesh.name = `PyramidFace_${f.name}`

		// Add edge lines (white wireframe)
	...
	// Base triangle uses v1, v2, v3 in reverse order so normal points downward
